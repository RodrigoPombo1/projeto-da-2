...
\begin{DoxyCompactList}\small\item\em Gets the written result of the Christofides heuristic algorithm complexity\+: O((n/2)!\texorpdfstring{$\ast$}{*}n) (n = number of nodes) \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Gets the result of the Christofides heuristic algorithm complexity\+: O((n/2)!\texorpdfstring{$\ast$}{*}n) (n = number of nodes) (the christofides heuristic algorithm is inefficient because of the minimum weight perfect matching brute force that could be done instead in polynomial time) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Gets the minimum weight perfect matching using brute force complexity\+: O((n/2)!\texorpdfstring{$\ast$}{*}n) (n = number of nodes) (there is a polynomial time algorithm that is better for this problem but it wasn\textquotesingle{}t implemented here) \end{DoxyCompactList}\item 
...
Gets the result of the Christofides heuristic algorithm complexity\+: O((n/2)!\texorpdfstring{$\ast$}{*}n) (n = number of nodes) (the christofides heuristic algorithm is inefficient because of the minimum weight perfect matching brute force that could be done instead in polynomial time) 
...
Gets the minimum weight perfect matching using brute force complexity\+: O((n/2)!\texorpdfstring{$\ast$}{*}n) (n = number of nodes) (there is a polynomial time algorithm that is better for this problem but it wasn\textquotesingle{}t implemented here) 
...
Gets the written result of the Christofides heuristic algorithm complexity\+: O((n/2)!\texorpdfstring{$\ast$}{*}n) (n = number of nodes) 
